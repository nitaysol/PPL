...
import { Env, generateClosureId } from './L4-env-box';
...
// Closure ID
export const closuredIdsMap = new Map();
export const makeClosure = (params: VarDecl[], body: CExp[], env: Env): Closure =>
    {
        let c: Closure = ({tag: "Closure", params, body, env});
        closuredIdsMap.set(c, generateClosureId());
        return c;
    }
